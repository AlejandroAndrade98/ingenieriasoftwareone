    ...
    <Container className="mt-5">
         <Row>
              <Col sm={{ size: 8, offset: 2 }}>
                   ...
                   <hr />
                   <Link className="btn btn-danger mb-3" to="/nuevoempleado" >Nuevo Empleado</Link>

                   <Table bordered className="table-secondary">
                        <thead>
                             <tr>
                                  <th>Nombre</th>
                                  <th>Correo</th>
                        ...
                        <tbody>
                             {
                                  empleados.map((item) => (
                                       <tr key={item.idEmpleado}>
                                            ...
                                            <td>{item.sueldo}</td>
                                            <td>
                                                 <Link className="btn me-2" to={`/editarempleado/${item.idEmpleado}`} >Editar</Link>
